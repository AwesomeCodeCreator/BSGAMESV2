...
// Main execution
function main() {
  console.log(`${colors.bright}${colors.cyan}💾 Saving duckmath.github.io-main state...${colors.reset}\n`);
  ...
  console.log(`${colors.bright}📁 Project:${colors.reset} ${colors.cyan}duckmath.github.io-main${colors.reset} (${colors.yellow}generic${colors.reset})`);
